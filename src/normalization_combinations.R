...
update_storage = function(inp, func, res){
  ## creates hash of the input and function, then adds it the result of applying 
  ## this function to the input to the object_storage
  inp_func_hash = rlang::hash(list(inp, func))
...
top_methods  = c('get_downsampled_data-no_correction-upper_quartile_normalize-no_scaling-pearson')
method_combinations %>%
